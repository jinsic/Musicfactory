...
public class base_sc : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject[] a = GameObject.FindGameObjectsWithTag("basebtn");
        ...
        test.GetComponent<flag>().sw.Start();
    ...
    void RaycastGun()
    {
        ...
        {
            if (hit.collider.gameObject.tag.ToString() == "basebtn")
            {

                //OVRHaptics.RightChannel. = true;
                ...
                //UnityEngine.Debug.Log(respawn.GetComponent<flag>().base_flag);
